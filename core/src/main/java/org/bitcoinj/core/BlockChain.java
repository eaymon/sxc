...
public class BlockChain extends AbstractBlockChain {
    ...
    private boolean isBuildingCheckfile;
    /**
    ...
    public void setBuildingCheckFile(boolean b) {
		isBuildingCheckfile = b;
		
	}
	
	public boolean isBuildingCheckFile(){
		return isBuildingCheckfile;
	}
}
