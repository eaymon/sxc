...
public class BitcoinSerializerTest {
    private static final byte[] ADDRESS_MESSAGE_BYTES = HEX.decode("face69696164647200000000000000001f000000" +
            "ed52399b01e215104d010000000000000000000000000000000000ffff0a000001208d");

    private static final byte[] TRANSACTION_MESSAGE_BYTES = HEX.withSeparator(" ", 2).decode(
            "fa ce 69 69 74 78 00 00  00 00 00 00 00 00 00 00" +
    ...
    public void testHeaders1() throws Exception {
        ...
        byte[] headersMessageBytes = HEX.decode("face6969686561" +
    ...
    public void testHeaders2() throws Exception {
        ...
        byte[] headersMessageBytes = HEX.decode("face69696865616465" +
