...
//SAmFmKFvSzFwV4ZXDo3pbo4nc44rM2o3Ce

//S4iPhRYE9rnTy8Zzk16RCAcMQwxHGow71X
//17kzeh4N8g49GFvdDzSf8PjaPfyoD1MndL

//1EXoDusjGwvnjZUyKkxZ4UHEf77z6A5S4P
//SBVCGeMbJ8f7SS8LqmcK8FA1gP6U6dXzcA

//testnet
//n4eA2nbYqErp7H6jebchxAN59DmNpksexv
//sJ2zqCUJ4atCjuury3wrFnuJKn7e3JSQbq
...
public class AddressTest {
    ...
    public void testJavaSerialization() throws Exception {
        Address testAddress = Address.fromBase58(testParams, "sJ2zqCUJ4atCjuury3wrFnuJKn7e3JSQbq");
        ...
        Address mainAddress = Address.fromBase58(mainParams, "S4iPhRYE9rnTy8Zzk16RCAcMQwxHGow71X");
    ...
    public void stringification() throws Exception {
        ...
        assertEquals("sJ2zqCUJ4atCjuury3wrFnuJKn7e3JSQbq", a.toString());
        assertFalse(a.isP2SHAddress());

        Address b = new Address(mainParams, HEX.decode("4a22c3c4cbb31e4d03b15550636762bda0baf85a"));
        assertEquals("S4iPhRYE9rnTy8Zzk16RCAcMQwxHGow71X", b.toString());
        assertFalse(b.isP2SHAddress());
    }
    
    @Test
    public void decoding() throws Exception {
        Address a = Address.fromBase58(testParams, "sJ2zqCUJ4atCjuury3wrFnuJKn7e3JSQbq");
        assertEquals("fda79a24e50ff70ff42f7d89585da5bd19d9e5cc", Utils.HEX.encode(a.getHash160()));

        Address b = Address.fromBase58(mainParams, "S4iPhRYE9rnTy8Zzk16RCAcMQwxHGow71X");
    ...
    public void errorPaths() {
        ...
        try {
            Address.fromBase58(testParams, "S4iPhRYE9rnTy8Zzk16RCAcMQwxHGow71X");
            fail();
        } catch (WrongNetworkException e) {
            // Success.
    ...
    public void getNetwork() throws Exception {
        NetworkParameters params = Address.getParametersFromAddress("S4iPhRYE9rnTy8Zzk16RCAcMQwxHGow71X");
        assertEquals(MainNetParams.get().getId(), params.getId());
        params = Address.getParametersFromAddress("sJ2zqCUJ4atCjuury3wrFnuJKn7e3JSQbq");
    ...
    public void getAltNetwork() throws Exception {
        ...
        params = Address.getParametersFromAddress("S4iPhRYE9rnTy8Zzk16RCAcMQwxHGow71X");
        assertEquals(MainNetParams.get().getId(), params.getId());
        // Unregister network
    ...
    public void roundtripBase58() throws Exception {
        String base58 = "S4iPhRYE9rnTy8Zzk16RCAcMQwxHGow71X";
        assertEquals(base58, Address.fromBase58(null, base58).toBase58());
    }
    @Test
    public void comparisonCloneEqualTo() throws Exception {
        Address a = Address.fromBase58(mainParams, "SAmFmKFvSzFwV4ZXDo3pbo4nc44rM2o3Ce");
        Address b = a.clone();
    ...
    public void comparisonLessThan() throws Exception {
        Address a = Address.fromBase58(mainParams, "SAmFmKFvSzFwV4ZXDo3pbo4nc44rM2o3Ce");
        Address b = Address.fromBase58(mainParams, "SBVCGeMbJ8f7SS8LqmcK8FA1gP6U6dXzcA");
    ...
    public void comparisonGreaterThan() throws Exception {
        Address a = Address.fromBase58(mainParams, "SBVCGeMbJ8f7SS8LqmcK8FA1gP6U6dXzcA");
        Address b = Address.fromBase58(mainParams, "SAmFmKFvSzFwV4ZXDo3pbo4nc44rM2o3Ce");
