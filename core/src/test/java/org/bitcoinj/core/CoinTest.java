...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 SXC", COIN.toFriendlyString());
        assertEquals("1.23 SXC", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 SXC", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 SXC", valueOf(1, 23).negate().toFriendlyString());
    }
